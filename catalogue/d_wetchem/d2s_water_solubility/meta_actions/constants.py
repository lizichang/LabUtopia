...
# —— 表面皿 / 粉末（/World/SurfaceDish (0.5365,0.0402,0.80)，粉末在皿内；2026-08-14 晚用户要求皿+粉 -X 移 15cm 给挖粉留间隙防穿模）——
# 粉丘实测 bbox：x 0.5188-0.5542（随皿 -X 移 15cm 同步），y 0.0166-0.064，z 0.8021-0.8141。
# 皿沿（rim）顶 z=0.8066 → 插入 z 必须 > 0.8066（过沿）且 < 0.8141（沉入粉）。
DISH_XY = (0.5365, 0.0402)
