...
几何：封口端=TCP 下探到 STICK_SEALED=(0.3471,0.2756,1.076) = 泡中心 (0.3471,0.2696,1.076) +Y 侧
（泡半径 5mm + 管半径 0.75mm ≈ 5.75mm），贴住泡表面；开口端沿竖直垂到 0.976（泡下方），
毛细管竖直平行贴温度计杆身，符合物理。随温度计法兰翻转/插管全程整组移动（_update_stuck_capillary）。
"""
