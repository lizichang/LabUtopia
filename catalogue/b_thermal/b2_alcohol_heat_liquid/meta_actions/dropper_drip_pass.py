...
避挂钩支臂（z 1.216..1.227, x 0.5086..0.6446, 罩住试管正上方）：
  - 横夹后滴管竖直挂夹爪下，杆体 z = 夹爪-0.13 ~ 夹爪。
  - 低空横越走 TRANSIT_Z=1.15：杆体 z∈[1.02,1.15] 全程在支臂底 1.216 之下。
  - 两段式滴液走 ORIENT_FWD（2026-08-25 用户：避免穿模）：夹爪 z1.2059+球 5.5mm=
    1.2114 在支臂底 1.216 之下；尖嘴在管口上方 2mm、杆体 z∈[1.076,1.206] 全在
