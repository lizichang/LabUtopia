...
布局（d2s 实测坐标 2026-08-14 起，2026-08-25 酸瓶/滴管新增；台面顶 z=0.80）：
  TestTubeRack  (0.6803, 0.3607)  工作区右侧（同 d2s，不动）
  TestTube      (0.659,  0.241, 0.806)  架近侧左孔（同 d2s，管口 z=0.9593）
  Spatula       (0.6993, 0.3608, 0.828, rotZ -180°)  架中心孔竖插（同 d2s）
  ...
  DropperAcid   (0.6993, 0.3209, 0.806)  酸滴管立插主试管架第二列第3排（用户 2026-08-26：①原右近孔
                                         ...
                                         ②远端排实测 IK 够不着→"第二列不变放第3排"=本位置，比药匙第4排还近必可达）
...
# 药匙/皿/粉/试管/试管架坐标与 d2s 完全一致（挖粉轨迹不动）；洗瓶位换成滴管架+酸滴管+酸瓶。
EQUIP = [
    ...
    # —— 酸试剂（滴管进主试管架第二列第3排，与药匙同架；盐酸瓶在原洗瓶附近）——
    ("DropperAcid", "dropper.usd", (0.6993, 0.3209, TUBE_BOTTOM), None, None),
...
# 药匙上粉末效果（d2s BUILTIN）：勺尖上方小粉堆
SPOON_POWDER_R = 0.005
SPOON_POWDER_H = 0.005
SPOON_POWDER_T = (0.6993, 0.3608, 0.965)
